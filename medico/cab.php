<?php
     ...
     * 
     */
    $selectUserInfo = "SELECT * FROM usuarios WHERE id_usuario = :usuario AND tipo = 1";
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <div class="sidebar-link "> 
                                    ...
                                    <span class="hide-menu" id="nomeUser"><?php echo ucfirst( strtolower( $_SESSION["usuario"] ) ); ?></span>
                                </div>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index.php"
                                    ...
                                    <span class="hide-menu">Meus pacientes</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="cadastro_paciente.php"
                                    aria-expanded="false">
