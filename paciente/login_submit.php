<?php
    ...
    if( isset($_POST["usuario"]) && isset($_POST["senha"]) ) {
        ...
        if($pos === false) {
            ...
            /**
             * 
             * Verifica o paciente a partir do nome
             * de usuario
             * 
             */
            $sql = "SELECT * FROM usuarios WHERE usuario = :usuario AND senha = :senha AND tipo = 0 AND apagado = 0";
            $sql = $pdo->prepare($sql);
        ...
        // caso email
            ...
            /**
             * 
             * Verifica o paciente a partir do email
             * de usuario
             * 
             */
            $sql = "SELECT * FROM usuarios WHERE email = :email AND senha = :senha AND tipo = 0 AND apagado = 0";
            $sql = $pdo->prepare($sql);
